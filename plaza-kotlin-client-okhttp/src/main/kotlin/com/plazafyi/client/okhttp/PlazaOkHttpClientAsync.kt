...
package com.plazafyi.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.plazafyi.client.PlazaClientAsync
import com.plazafyi.client.PlazaClientAsyncImpl
...
/**
 * A class that allows building an instance of [PlazaClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class PlazaOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [PlazaClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): PlazaClientAsync = builder().fromEnv().build()
    }

    /** A builder for [PlazaOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.plazafyi.core.jsonMapper]. The default is usually sufficient and rarely
         ...
         *
         * Defaults to the production environment: `https://plaza.fyi`.
         *
        ...
        /** Sets [baseUrl] to `http://localhost:4000`. */
        ...
        /**
         * Returns an immutable instance of [PlazaClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlazaClientAsync =
            PlazaClientAsyncImpl(
                clientOptions
                    .httpClient(
