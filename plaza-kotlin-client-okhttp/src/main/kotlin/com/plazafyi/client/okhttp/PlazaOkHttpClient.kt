...
/**
 * A class that allows building an instance of [PlazaClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class PlazaOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [PlazaClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): PlazaClient = builder().fromEnv().build()
    }

    /** A builder for [PlazaOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [PlazaClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlazaClient =
            PlazaClientImpl(
                clientOptions
                    .httpClient(
