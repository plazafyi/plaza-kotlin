...
dependencies {
    testImplementation(project(":plaza-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../plaza-kotlin-core/src/main/resources/META-INF/proguard/plaza-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.plazafyi.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../plaza-kotlin-core/src/main/resources/META-INF/proguard/plaza-kotlin-core.pro",
