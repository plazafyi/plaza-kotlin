...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.plazafyi.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.plazafyi.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.plazafyi.** {
    <init>(...);
