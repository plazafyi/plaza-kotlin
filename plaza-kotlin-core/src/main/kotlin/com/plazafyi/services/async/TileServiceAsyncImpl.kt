...
class TileServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TileServiceAsync =
        TileServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())

    override suspend fun get(params: TileGetParams, requestOptions: RequestOptions): HttpResponse =
