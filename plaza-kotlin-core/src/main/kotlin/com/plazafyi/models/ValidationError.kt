...
/**
 * Validation error with per-field details. The `details` object maps field names to arrays of error
 * messages.
 */
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ValidationError].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(validationError: ValidationError) = apply {
            error = validationError.error
            additionalProperties = validationError.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ValidationError].
         *
        ...
        fun build(): ValidationError =
            ValidationError(checkRequired("error", error), additionalProperties.toMutableMap())
    }
    ...
    private constructor(
        ...
        class Code @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val VALIDATION_FAILED = of("validation_failed")
            ...
            fun known(): Known =
                when (this) {
                    ...
                    else -> throw PlazaInvalidDataException("Unknown Code: $value")
                }
        ...
        override fun toString() =
            "Error{code=$code, message=$message, details=$details, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "ValidationError{error=$error, additionalProperties=$additionalProperties}"
}
