 ...
 * exterior boundary and subsequent rings are holes. Each ring must have at least 4 positions with
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PolygonGeometry].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(polygonGeometry: PolygonGeometry) = apply {
            coordinates = polygonGeometry.coordinates.map { it.toMutableList() }
            type = polygonGeometry.type
            additionalProperties = polygonGeometry.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PolygonGeometry].
         *
     ...
     *   type.
     */
    fun validate(): PolygonGeometry = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "PolygonGeometry{coordinates=$coordinates, type=$type, additionalProperties=$additionalProperties}"
}
