...
private constructor(
    ...
    companion object {
        ...
        fun none(): ElementQueryPostParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ElementQueryPostParams]. */
        fun builder() = Builder()
    }

    /** A builder for [ElementQueryPostParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(elementQueryPostParams: ElementQueryPostParams) = apply {
            bbox = elementQueryPostParams.bbox
            contains = elementQueryPostParams.contains
            crosses = elementQueryPostParams.crosses
            cursor = elementQueryPostParams.cursor
            format = elementQueryPostParams.format
            h3 = elementQueryPostParams.h3
            intersects = elementQueryPostParams.intersects
            limit = elementQueryPostParams.limit
            near = elementQueryPostParams.near
            outputBuffer = elementQueryPostParams.outputBuffer
            outputCentroid = elementQueryPostParams.outputCentroid
            outputFields = elementQueryPostParams.outputFields
            outputGeometry = elementQueryPostParams.outputGeometry
            outputInclude = elementQueryPostParams.outputInclude
            outputPrecision = elementQueryPostParams.outputPrecision
            outputSimplify = elementQueryPostParams.outputSimplify
            outputSort = elementQueryPostParams.outputSort
            radius = elementQueryPostParams.radius
            touches = elementQueryPostParams.touches
            type = elementQueryPostParams.type
            within = elementQueryPostParams.within
            additionalHeaders = elementQueryPostParams.additionalHeaders.toBuilder()
            additionalQueryParams = elementQueryPostParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                elementQueryPostParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ElementQueryPostParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ElementQueryPostParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ElementQueryPostParams &&
            bbox == other.bbox &&
    ...
    override fun toString() =
        "ElementQueryPostParams{bbox=$bbox, contains=$contains, crosses=$crosses, cursor=$cursor, format=$format, h3=$h3, intersects=$intersects, limit=$limit, near=$near, outputBuffer=$outputBuffer, outputCentroid=$outputCentroid, outputFields=$outputFields, outputGeometry=$outputGeometry, outputInclude=$outputInclude, outputPrecision=$outputPrecision, outputSimplify=$outputSimplify, outputSort=$outputSort, radius=$radius, touches=$touches, type=$type, within=$within, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
