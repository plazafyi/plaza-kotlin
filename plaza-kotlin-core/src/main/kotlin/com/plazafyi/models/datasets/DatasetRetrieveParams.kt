...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): DatasetRetrieveParams =
            DatasetRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "DatasetRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
