...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ElevationProfileParams].
         *
    ...
    /** A builder for [ElevationProfileParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(elevationProfileParams: ElevationProfileParams) = apply {
            elevationProfileRequest = elevationProfileParams.elevationProfileRequest
            additionalHeaders = elevationProfileParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [ElevationProfileParams].
         *
         ...
         */
        fun build(): ElevationProfileParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ElevationProfileParams &&
    ...
    override fun toString() =
        "ElevationProfileParams{elevationProfileRequest=$elevationProfileRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
