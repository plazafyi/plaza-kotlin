...
private constructor(
    private val features: JsonField<List<ElevationLookupResult>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        features: JsonField<List<ElevationLookupResult>> = JsonMissing.of(),
     ...
     */
    fun features(): List<ElevationLookupResult> = features.getRequired("features")
    ...
    @JsonProperty("features")
    @ExcludeMissing
    fun _features(): JsonField<List<ElevationLookupResult>> = features
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ElevationBatchResult].
         *
    ...
    /** A builder for [ElevationBatchResult]. */
    class Builder internal constructor() {

        private var features: JsonField<MutableList<ElevationLookupResult>>? = null
        private var type: JsonField<Type>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(elevationBatchResult: ElevationBatchResult) = apply {
            features = elevationBatchResult.features.map { it.toMutableList() }
            type = elevationBatchResult.type
         ...
         * `List<ElevationLookupResult>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun features(features: JsonField<List<ElevationLookupResult>>) = apply {
            this.features = features.map { it.toMutableList() }
        }

        /**
         * Adds a single [ElevationLookupResult] to [features].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addFeature(feature: ElevationLookupResult) = apply {
            features =
        ...
        /**
         * Returns an immutable instance of [ElevationBatchResult].
         *
         ...
         */
        fun build(): ElevationBatchResult =
    ...
    fun validate(): ElevationBatchResult = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ElevationBatchResult &&
    ...
    override fun toString() =
        "ElevationBatchResult{features=$features, type=$type, additionalProperties=$additionalProperties}"
}
