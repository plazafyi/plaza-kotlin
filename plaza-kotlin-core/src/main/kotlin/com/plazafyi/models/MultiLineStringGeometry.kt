...
private constructor(
     ...
     */
    fun coordinates(): List<List<List<Double>>> = coordinates.getRequired("coordinates")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultiLineStringGeometry].
         *
    ...
    /** A builder for [MultiLineStringGeometry]. */
    class Builder internal constructor() {
        ...
        internal fun from(multiLineStringGeometry: MultiLineStringGeometry) = apply {
            coordinates = multiLineStringGeometry.coordinates.map { it.toMutableList() }
            type = multiLineStringGeometry.type
            additionalProperties = multiLineStringGeometry.additionalProperties.toMutableMap()
        }
         ...
         * `List<List<List<Double>>>` value instead. This method is primarily for setting the field
        ...
        /**
         * Returns an immutable instance of [MultiLineStringGeometry].
         *
         ...
         */
        fun build(): MultiLineStringGeometry =
     ...
     *   type.
     */
    fun validate(): MultiLineStringGeometry = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (coordinates.asKnown()?.sumOf { it.sumOf { it.size.toInt() }.toInt() } ?: 0) +
    ...
    override fun toString() =
        "MultiLineStringGeometry{coordinates=$coordinates, type=$type, additionalProperties=$additionalProperties}"
}
