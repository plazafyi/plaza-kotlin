...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeatureCollection].
         *
    ...
    /** A builder for [FeatureCollection]. */
    class Builder internal constructor() {
        ...
        internal fun from(featureCollection: FeatureCollection) = apply {
            features = featureCollection.features.map { it.toMutableList() }
        ...
        /**
         * Returns an immutable instance of [FeatureCollection].
         *
    ...
    fun validate(): FeatureCollection = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "FeatureCollection{features=$features, type=$type, additionalProperties=$additionalProperties}"
}
