...
private constructor(
    ...
    private val plazaqlQuery: PlazaqlQuery,
     ...
     * returned as GeoJSON.
     */
    fun plazaqlQuery(): PlazaqlQuery = plazaqlQuery

    fun _additionalBodyProperties(): Map<String, JsonValue> = plazaqlQuery._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var plazaqlQuery: PlazaqlQuery? = null
        private var additionalHeaders: Headers.Builder = Headers.builder()
        private var additionalQueryParams: QueryParams.Builder = QueryParams.builder()

        internal fun from(queryExecuteParams: QueryExecuteParams) = apply {
            format = queryExecuteParams.format
            plazaqlQuery = queryExecuteParams.plazaqlQuery
         ...
         * returned as GeoJSON.
         */
        fun plazaqlQuery(plazaqlQuery: PlazaqlQuery) = apply { this.plazaqlQuery = plazaqlQuery }
        ...
        fun build(): QueryExecuteParams =
            QueryExecuteParams(
                format,
                checkRequired("plazaqlQuery", plazaqlQuery),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): PlazaqlQuery = plazaqlQuery
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is QueryExecuteParams &&
            format == other.format &&
            plazaqlQuery == other.plazaqlQuery &&
            additionalHeaders == other.additionalHeaders &&
            additionalQueryParams == other.additionalQueryParams
    }

    override fun hashCode(): Int =
        Objects.hash(format, plazaqlQuery, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "QueryExecuteParams{format=$format, plazaqlQuery=$plazaqlQuery, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
