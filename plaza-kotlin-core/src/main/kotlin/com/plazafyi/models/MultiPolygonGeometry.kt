...
private constructor(
    private val coordinates: JsonField<List<List<List<List<Double>>>>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        coordinates: JsonField<List<List<List<List<Double>>>>> = JsonMissing.of(),
     ...
     */
    fun coordinates(): List<List<List<List<Double>>>> = coordinates.getRequired("coordinates")
    ...
    @JsonProperty("coordinates")
    @ExcludeMissing
    fun _coordinates(): JsonField<List<List<List<List<Double>>>>> = coordinates
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultiPolygonGeometry].
         *
    ...
    /** A builder for [MultiPolygonGeometry]. */
    class Builder internal constructor() {

        private var coordinates: JsonField<MutableList<List<List<List<Double>>>>>? = null
        private var type: JsonField<Type>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(multiPolygonGeometry: MultiPolygonGeometry) = apply {
            coordinates = multiPolygonGeometry.coordinates.map { it.toMutableList() }
            type = multiPolygonGeometry.type
            additionalProperties = multiPolygonGeometry.additionalProperties.toMutableMap()
        }

        /** Array of Polygon coordinate arrays */
        fun coordinates(coordinates: List<List<List<List<Double>>>>) =
         ...
         * `List<List<List<List<Double>>>>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun coordinates(coordinates: JsonField<List<List<List<List<Double>>>>>) = apply {
            this.coordinates = coordinates.map { it.toMutableList() }
        }

        /**
         * Adds a single [List<List<List<Double>>>] to [coordinates].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addCoordinate(coordinate: List<List<List<Double>>>) = apply {
            coordinates =
        ...
        /**
         * Returns an immutable instance of [MultiPolygonGeometry].
         *
         ...
         */
        fun build(): MultiPolygonGeometry =
     ...
     *   type.
     */
    fun validate(): MultiPolygonGeometry = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (coordinates.asKnown()?.sumOf { it.sumOf { it.sumOf { it.size.toInt() }.toInt() }.toInt() }
            ?: 0) + (type.asKnown()?.validity() ?: 0)
    ...
    override fun toString() =
        "MultiPolygonGeometry{coordinates=$coordinates, type=$type, additionalProperties=$additionalProperties}"
}
