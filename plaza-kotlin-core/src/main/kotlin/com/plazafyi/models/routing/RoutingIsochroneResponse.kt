...
/**
 * GeoJSON FeatureCollection of isochrone polygons — areas reachable within the specified travel
 * time(s). Each Feature is a Polygon contour with travel time and area metadata in properties.
 */
...
private constructor(
    ...
    override fun toString() =
        "RoutingIsochroneResponse{features=$features, type=$type, additionalProperties=$additionalProperties}"
}
