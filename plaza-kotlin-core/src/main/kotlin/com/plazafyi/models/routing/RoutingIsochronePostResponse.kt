...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RoutingIsochronePostResponse].
         */
        fun builder() = Builder()
    }

    /** A builder for [RoutingIsochronePostResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(routingIsochronePostResponse: RoutingIsochronePostResponse) = apply {
            features = routingIsochronePostResponse.features.map { it.toMutableList() }
            geometry = routingIsochronePostResponse.geometry
            properties = routingIsochronePostResponse.properties
            type = routingIsochronePostResponse.type
            additionalProperties = routingIsochronePostResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RoutingIsochronePostResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RoutingIsochronePostResponse =
    ...
    fun validate(): RoutingIsochronePostResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RoutingIsochronePostResponse &&
    ...
    override fun toString() =
        "RoutingIsochronePostResponse{features=$features, geometry=$geometry, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}
