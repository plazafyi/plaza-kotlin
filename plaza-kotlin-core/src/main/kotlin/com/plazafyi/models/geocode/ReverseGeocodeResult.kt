...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ReverseGeocodeResult].
         *
    ...
    /** A builder for [ReverseGeocodeResult]. */
    class Builder internal constructor() {
        ...
        internal fun from(reverseGeocodeResult: ReverseGeocodeResult) = apply {
            features = reverseGeocodeResult.features.map { it.toMutableList() }
            type = reverseGeocodeResult.type
        ...
        /**
         * Returns an immutable instance of [ReverseGeocodeResult].
         *
         ...
         */
        fun build(): ReverseGeocodeResult =
    ...
    fun validate(): ReverseGeocodeResult = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReverseGeocodeResult &&
    ...
    override fun toString() =
        "ReverseGeocodeResult{features=$features, type=$type, additionalProperties=$additionalProperties}"
}
