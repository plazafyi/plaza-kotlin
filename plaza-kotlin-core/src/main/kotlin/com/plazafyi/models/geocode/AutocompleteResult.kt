...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutocompleteResult].
         *
    ...
    /** A builder for [AutocompleteResult]. */
    class Builder internal constructor() {
        ...
        internal fun from(autocompleteResult: AutocompleteResult) = apply {
            features = autocompleteResult.features.map { it.toMutableList() }
        ...
        /**
         * Returns an immutable instance of [AutocompleteResult].
         *
    ...
    fun validate(): AutocompleteResult = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "AutocompleteResult{features=$features, type=$type, additionalProperties=$additionalProperties}"
}
