...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultiPointGeometry].
         *
    ...
    /** A builder for [MultiPointGeometry]. */
    class Builder internal constructor() {
        ...
        internal fun from(multiPointGeometry: MultiPointGeometry) = apply {
            coordinates = multiPointGeometry.coordinates.map { it.toMutableList() }
            type = multiPointGeometry.type
            additionalProperties = multiPointGeometry.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MultiPointGeometry].
         *
     ...
     *   type.
     */
    fun validate(): MultiPointGeometry = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "MultiPointGeometry{coordinates=$coordinates, type=$type, additionalProperties=$additionalProperties}"
}
